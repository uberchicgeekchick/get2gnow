...
CFLAGS = -std=gnu99 -Wall -Wextra -Wno-missing-field-initializers -Wfatal-errors --combine -Wformat=2 -Wswitch-default -Wswitch-enum -O3 -L/lib64 -L/usr/lib64 -L/usr/lib -L/lib -I/usr/include
CPP = /usr/bin/cpp
CPPFLAGS = -I/usr/include
CXX = g++
CXXCPP = g++ -E
CXXDEPMODE = depmode=gcc3
CXXFLAGS = -std=gnu++0x -Wall -Wextra -Wno-missing-field-initializers -Wfatal-errors --combine -Wformat=2 -Wswitch-default -Wswitch-enum -O3 -L/lib64 -L/usr/lib64 -L/usr/lib -L/lib -I/usr/include
CYGPATH_W = echo
DATADIRNAME = share
...
PACKAGE_STRING = Greet-Tweet-Know 0.1.0.2
...
WARN_CXXFLAGS = -std=gnu++0x -Wall -Wextra -Wno-missing-field-initializers -Wfatal-errors --combine -Wformat=2 -Wswitch-default -Wswitch-enum -O3 -L/lib64 -L/usr/lib64 -L/usr/lib -L/lib -I/usr/include -Wall -Wno-unused 
