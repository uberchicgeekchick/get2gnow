...
ACLOCAL = ${SHELL} /programs/src/twitux/missing --run aclocal-1.10
ALL_LINGUAS = 
AMTAR = ${SHELL} /programs/src/twitux/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /programs/src/twitux/missing --run autoconf
AUTOHEADER = ${SHELL} /programs/src/twitux/missing --run autoheader
AUTOMAKE = ${SHELL} /programs/src/twitux/missing --run automake-1.10
AWK = gawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /programs/src/twitux/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
TWITUX_LIBS = -L/usr/lib64 -L/lib64 -lsexy -lxml2 -lcanberra-gtk -lcanberra -lsoup-2.4 -lnotify -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lgdk_pixbuf-2.0 -lpangocairo-1.0 -lcairo -lpango-1.0 -lfreetype -lz -lfontconfig -lgmodule-2.0 -ldbus-glib-1 -ldbus-1 -lgobject-2.0 -lglib-2.0  
USE_NLS = yes
VERSION = 0.69
...
abs_builddir = /programs/src/twitux
abs_srcdir = /programs/src/twitux
abs_top_builddir = /programs/src/twitux
abs_top_srcdir = /programs/src/twitux
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_F77 = 
am__include = include
...
install_sh = $(SHELL) /programs/src/twitux/install-sh
libdir = /usr/lib64
