...
# 1 "/usr/include/gconf/2/gconf/gconf-client.h" 1
# 24 "/usr/include/gconf/2/gconf/gconf-client.h"
...
# 25 "/usr/include/gconf/2/gconf/gconf-client.h" 2
# 1 "/usr/include/gconf/2/gconf/gconf.h" 1
# 25 "/usr/include/gconf/2/gconf/gconf.h"


# 1 "/usr/include/gconf/2/gconf/gconf-schema.h" 1
# 26 "/usr/include/gconf/2/gconf/gconf-schema.h"
# 1 "/usr/include/gconf/2/gconf/gconf-value.h" 1
# 25 "/usr/include/gconf/2/gconf/gconf-value.h"
# 1 "/usr/include/gconf/2/gconf/gconf-error.h" 1
# 25 "/usr/include/gconf/2/gconf/gconf-error.h"
...
# 26 "/usr/include/gconf/2/gconf/gconf-value.h" 2
...
# 124 "/usr/include/gconf/2/gconf/gconf-value.h"
...
# 27 "/usr/include/gconf/2/gconf/gconf-schema.h" 2


# 37 "/usr/include/gconf/2/gconf/gconf-schema.h"
...
# 28 "/usr/include/gconf/2/gconf/gconf.h" 2
# 1 "/usr/include/gconf/2/gconf/gconf-engine.h" 1
# 24 "/usr/include/gconf/2/gconf/gconf-engine.h"
# 1 "/usr/include/gconf/2/gconf/gconf-error.h" 1
# 25 "/usr/include/gconf/2/gconf/gconf-engine.h" 2
...
# 52 "/usr/include/gconf/2/gconf/gconf-engine.h"
...
# 29 "/usr/include/gconf/2/gconf/gconf.h" 2

# 1 "/usr/include/gconf/2/gconf/gconf-enum-types.h" 1
# 9 "/usr/include/gconf/2/gconf/gconf-enum-types.h"
...
# 31 "/usr/include/gconf/2/gconf/gconf.h" 2
...
GConfSchema* gconf_engine_get_schema (GConfEngine *conf,
                                      const gchar *key,
                                      GError **err);
# 186 "/usr/include/gconf/2/gconf/gconf.h"
GSList* gconf_engine_get_list (GConfEngine *conf,
                                      const gchar *key,
                                      GConfValueType list_type,
                                      GError **err);
# 200 "/usr/include/gconf/2/gconf/gconf.h"
...
# 305 "/usr/include/gconf/2/gconf/gconf.h"

# 26 "/usr/include/gconf/2/gconf/gconf-client.h" 2
# 1 "/usr/include/gconf/2/gconf/gconf-listeners.h" 1
# 25 "/usr/include/gconf/2/gconf/gconf-listeners.h"

# 35 "/usr/include/gconf/2/gconf/gconf-listeners.h"
...
# 27 "/usr/include/gconf/2/gconf/gconf-client.h" 2
# 1 "/usr/include/gconf/2/gconf/gconf-changeset.h" 1
# 25 "/usr/include/gconf/2/gconf/gconf-changeset.h"

# 37 "/usr/include/gconf/2/gconf/gconf-changeset.h"
...
# 28 "/usr/include/gconf/2/gconf/gconf-client.h" 2


# 57 "/usr/include/gconf/2/gconf/gconf-client.h"
typedef enum {
...
typedef void (*GConfClientErrorHandlerFunc) (GConfClient* client,
                                             GError* error);
# 89 "/usr/include/gconf/2/gconf/gconf-client.h"
struct _GConfClient
{
  GObject object;
...
struct _GConfClientClass
{
  ...
  void (* value_changed) (GConfClient* client,
                          const gchar* key,
                          GConfValue* value);
# 131 "/usr/include/gconf/2/gconf/gconf-client.h"
...
void gconf_client_remove_dir (GConfClient* client,
                                            const gchar* dir,
                                            GError** err);
# 181 "/usr/include/gconf/2/gconf/gconf-client.h"
...
# 203 "/usr/include/gconf/2/gconf/gconf-client.h"
...
# 224 "/usr/include/gconf/2/gconf/gconf-client.h"
...
static void conf_init (Conf *self); static void conf_class_init (ConfClass *klass); static gpointer conf_parent_class = ((void *)0); static void conf_class_intern_init (gpointer klass) { conf_parent_class = g_type_class_peek_parent (klass); conf_class_init ((ConfClass*) klass); } GType conf_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if (g_once_init_enter (&g_define_type_id__volatile)) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("Conf"), sizeof (ConfClass), (GClassInitFunc) conf_class_intern_init, sizeof (Conf), (GInstanceInitFunc) conf_init, (GTypeFlags) 0); { {{};} } g_once_init_leave (&g_define_type_id__volatile, g_define_type_id); } return g_define_type_id__volatile; };

static Conf *global_conf = ((void *)0);
static ConfPriv *config_priv=((void *)0);
...
conf_class_init(ConfClass *class)
{
 ...
 object_class = ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((class)), (((GType) ((20) << (2))))))));
...
conf_init(Conf *conf)
{
 ...
 config_priv = (((ConfPriv*) g_type_instance_get_private ((GTypeInstance*) ((conf)), ((conf_get_type ())))));

 config_priv->gconf_client = gconf_client_get_default();

 gconf_client_add_dir(config_priv->gconf_client,
        "/apps/greet-tweet-know",
        GCONF_CLIENT_PRELOAD_ONELEVEL,
        ((void *)0));
 gconf_client_add_dir(config_priv->gconf_client,
...
conf_finalize(GObject *object)
{
 ...
 ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((conf_parent_class)), (((GType) ((20) << (2))))))))->finalize(object);
}
...
{
 if(!global_conf) {
  global_conf = g_object_new((conf_get_type ()), ((void *)0));
 }
      ...
      gint value)
{
 ...
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((conf)); GType __t = ((conf_get_type ())); gboolean __r; if (__inst && __inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "IS_CONF(conf)"); return ((0)); }; }while (0);

 debug_impl ("Config", "Setting int:'%s' to %d", key, value);
 ...
 *value = 0;
 ...
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((conf)); GType __t = ((conf_get_type ())); gboolean __r; if (__inst && __inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "IS_CONF(conf)"); return ((0)); }; }while (0);
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (value != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "value != NULL"); return ((0)); }; }while (0);
 ...
 *value = gconf_client_get_int(config_priv->gconf_client,
 ...
 debug_impl ("Config", "Getting int:'%s'(=%d), error:'%s'", key, *value, error ? error->message : "None");
       ...
       gboolean value)
{
 ...
 debug_impl ("Config", "Setting bool:'%s' to %d ---> %s", key, value, value ? "true" : "false");
 ...
 *value = gconf_client_get_bool(config_priv->gconf_client,
 ...
 debug_impl ("Config", "Getting bool:'%s'(=%d ---> %s), error:'%s'", key, *value, *value ? "true" : "false", error ? error->message : "None");
      ...
      const gchar *value)
{
 ...
 debug_impl ("Config", "Setting string:'%s' to '%s'", key, value);
 ...
 *value = gconf_client_get_string(config_priv->gconf_client,
 ...
 debug_impl ("Config", "Getting string:'%s'(='%s'), error:'%s'", key, *value, error ? error->message : "None");
...
conf_notify_data_free(ConfNotifyData *data)
{
 ...
 do { if (1) g_slice_free1 (sizeof (ConfNotifyData), (data)); else (void) ((ConfNotifyData*) 0 == (data)); } while (0);
}
      ...
      gpointer user_data)
{
 ...
 data = ((ConfNotifyData*) g_slice_alloc (sizeof (ConfNotifyData)));
 data->func = func;
