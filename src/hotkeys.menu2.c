		...
		case GDK_MOD1_MASK:
			switch(event->keyval){
				...
				case GDK_N:	case GDK_n:
					gtk_menu_popup(main_window_get_menu("network"), GTK_WIDGET(GTK_MENU_SHELL(main_menu_get_main_main())), GTK_WIDGET(main_window_get_menu_item("network")), NULL, NULL, 0, event->time);
					return;
				case GDK_B:	case GDK_b:
					gtk_menu_popup(main_window_get_menu("tabs"), GTK_WIDGET(GTK_MENU_SHELL(main_menu_get_main_main())), GTK_WIDGET(main_window_get_menu_item("tabs")), NULL, NULL, 0, event->time);
					return;
				case GDK_E:	case GDK_e:
					gtk_menu_popup(main_window_get_menu("edit"), GTK_WIDGET(GTK_MENU_SHELL(main_menu_get_main_main())), GTK_WIDGET(main_window_get_menu_item("edit")), NULL, NULL, 0, event->time);
					return;
				case GDK_V:	case GDK_v:
					gtk_menu_popup(main_window_get_menu("view"), GTK_WIDGET(GTK_MENU_SHELL(main_menu_get_main_main())), GTK_WIDGET(main_window_get_menu_item("view")), NULL, NULL, 0, event->time);
					return;
				case GDK_T:	case GDK_t:
					gtk_menu_popup(main_window_get_menu("online_service_request"), GTK_WIDGET(GTK_MENU_SHELL(main_menu_get_main_main())), GTK_WIDGET(main_window_get_menu_item("online_service_request")), NULL, NULL, 0, event->time);
					return;
				case GDK_H:	case GDK_h:
					gtk_menu_popup(main_window_get_menu("help"), GTK_WIDGET(GTK_MENU_SHELL(main_menu_get_main_main())), GTK_WIDGET(main_window_get_menu_item("help")), NULL, NULL, 0, event->time);
					return;
