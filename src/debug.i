...
debug_init (void)
{
 ...
 if (!inited) {
  ...
  for (i = 0; debug_strv && debug_strv[i]; i++) {
   if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p ("all") && __builtin_constant_p (debug_strv[i]) && (__s1_len = strlen ("all"), __s2_len = strlen (debug_strv[i]), (!((size_t)(const void *)(("all") + 1) - (size_t)(const void *)("all") == 1) || __s1_len >= 4) && (!((size_t)(const void *)((debug_strv[i]) + 1) - (size_t)(const void *)(debug_strv[i]) == 1) || __s2_len >= 4)) ? __builtin_strcmp ("all", debug_strv[i]) : (__builtin_constant_p ("all") && ((size_t)(const void *)(("all") + 1) - (size_t)(const void *)("all") == 1) && (__s1_len = strlen ("all"), __s1_len < 4) ? (__builtin_constant_p (debug_strv[i]) && ((size_t)(const void *)((debug_strv[i]) + 1) - (size_t)(const void *)(debug_strv[i]) == 1) ? __builtin_strcmp ("all", debug_strv[i]) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (debug_strv[i]); register int __result = (((__const unsigned char *) (__const char *) ("all"))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("all"))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) ("all"))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) ("all"))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (debug_strv[i]) && ((size_t)(const void *)((debug_strv[i]) + 1) - (size_t)(const void *)(debug_strv[i]) == 1) && (__s2_len = strlen (debug_strv[i]), __s2_len < 4) ? (__builtin_constant_p ("all") && ((size_t)(const void *)(("all") + 1) - (size_t)(const void *)("all") == 1) ? __builtin_strcmp ("all", debug_strv[i]) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) ("all"); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (debug_strv[i]))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (debug_strv[i]))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (debug_strv[i]))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (debug_strv[i]))[3]); } } __result; }))) : __builtin_strcmp ("all", debug_strv[i])))); }) == 0) {
    all_domains = (!(0));
   }
  }
...
debug_impl (const gchar *domain, const gchar *msg, ...)
{
 ...
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (domain != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "domain != NULL"); return; }; }while (0);
 do{ if (__builtin_expect (__extension__ ({ int _g_boolean_var_; if (msg != ((void *)0)) _g_boolean_var_ = 1; else _g_boolean_var_ = 0; _g_boolean_var_; }), 1)) { } else { g_return_if_fail_warning (((gchar*) 0), __PRETTY_FUNCTION__, "msg != NULL"); return; }; }while (0);

 debug_init ();

 for (i = 0; debug_strv && debug_strv[i]; i++) {
  if (all_domains || __extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (domain) && __builtin_constant_p (debug_strv[i]) && (__s1_len = strlen (domain), __s2_len = strlen (debug_strv[i]), (!((size_t)(const void *)((domain) + 1) - (size_t)(const void *)(domain) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((debug_strv[i]) + 1) - (size_t)(const void *)(debug_strv[i]) == 1) || __s2_len >= 4)) ? __builtin_strcmp (domain, debug_strv[i]) : (__builtin_constant_p (domain) && ((size_t)(const void *)((domain) + 1) - (size_t)(const void *)(domain) == 1) && (__s1_len = strlen (domain), __s1_len < 4) ? (__builtin_constant_p (debug_strv[i]) && ((size_t)(const void *)((debug_strv[i]) + 1) - (size_t)(const void *)(debug_strv[i]) == 1) ? __builtin_strcmp (domain, debug_strv[i]) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (debug_strv[i]); register int __result = (((__const unsigned char *) (__const char *) (domain))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (domain))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (domain))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (domain))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (debug_strv[i]) && ((size_t)(const void *)((debug_strv[i]) + 1) - (size_t)(const void *)(debug_strv[i]) == 1) && (__s2_len = strlen (debug_strv[i]), __s2_len < 4) ? (__builtin_constant_p (domain) && ((size_t)(const void *)((domain) + 1) - (size_t)(const void *)(domain) == 1) ? __builtin_strcmp (domain, debug_strv[i]) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (domain); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (debug_strv[i]))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (debug_strv[i]))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (debug_strv[i]))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (debug_strv[i]))[3]); } } __result; }))) : __builtin_strcmp (domain, debug_strv[i])))); }) == 0) {
   va_list args;
