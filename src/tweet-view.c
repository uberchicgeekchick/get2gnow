...
void tweet_view_set_embed_toggle_and_image(void){
	if(gconfig_if_bool(PREFS_UI_TWEET_VIEW_USE_DIALOG, FALSE)==gtk_toggle_button_get_active(tweet_view->embed_togglebutton))
		return;
