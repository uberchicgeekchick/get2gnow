...
static gchar *www_format_service_hyperlink(OnlineService *service, const gchar *url_prefix, gchar *services_resource, gboolean expand_hyperlinks, gboolean make_hyperlinks, gboolean titles_strip_uris);
static gchar *www_find_user_title(OnlineService *service, const gchar *uri, const gchar *services_resource, gboolean expand_hyperlinks, gboolean make_hyperlinks, gboolean titles_strip_uris);
...
gchar *www_format_urls(OnlineService *service, const gchar *message, gboolean expand_hyperlinks, gboolean make_hyperlinks){
	...
	for(gint i=0; words[i]; i++) {
		...
		temp=www_format_service_hyperlink(service, url_prefix, words[i], expand_hyperlinks, make_hyperlinks, titles_strip_uris );
...
static gchar *www_format_service_hyperlink(OnlineService *service, const gchar *url_prefix, gchar *services_resource, gboolean expand_hyperlinks, gboolean make_hyperlinks, gboolean titles_strip_uris){
	...
	if(!gconfig_if_bool(PREFS_URLS_EXPANSION_USER_PROFILES, TRUE))
		...
		title=www_find_user_title(service, uri, services_resource, expand_hyperlinks, make_hyperlinks, titles_strip_uris);
	...
	return user_at_link;
}/*www_format_service_hyperlink(service, "https://identi.ca/", "@user"||"#search||"!tag", expand_hyperlinks, make_hyperlinks, titles_strip_uris);*/
...
static gchar *www_find_user_title(OnlineService *service, const gchar *uri, const gchar *services_resource, gboolean expand_hyperlinks, gboolean make_hyperlinks, gboolean titles_strip_uris){
	...
	title=www_find_uri_pages_title(service, uri, services_resource, expand_hyperlinks, make_hyperlinks, titles_strip_uris);
...
static gchar *www_find_uri_pages_title(OnlineService *service, const gchar *uri, const gchar *services_resource, gboolean expand_hyperlinks, gboolean make_hyperlinks, gboolean titles_strip_uris){
	...
	if(!make_hyperlinks)
		temp=g_strdup_printf("<u>%%s%s</u>", uri_title );
	else
	...
	return temp;
}/*www_find_uri_pages_title(service, uri, "@user"||"#search||"!tag", expand_hyperlinks, make_hyperlinks, titles_strip_uris);*/
